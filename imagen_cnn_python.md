...
- [Análisis de imagen con CNN (Python)](#análisis-de-imagen-con-cnn-python)
    - [Contenido](#contenido)
    - [Bibliotecas](#bibliotecas)
        - [Interacción con el entorno](#interacción-con-el-entorno)
        - [Bibliotecas para el uso de GPU (principales)](#bibliotecas-para-el-uso-de-gpu-principales)
        - [Bibliotecas para el uso de GPU (anejas)](#bibliotecas-para-el-uso-de-gpu-anejas)
        - [Bibliotecas de matemáticas](#bibliotecas-de-matemáticas)
        - [Biblioteca para testear la red](#biblioteca-para-testear-la-red)
        - [Bibliotecas de gráficas](#bibliotecas-de-gráficas)
        - [Otras bibliotecas](#otras-bibliotecas)
    - [Uso de cuadernos en *Google Colab*](#uso-de-cuadernos-en-google-colab)
        - [Mostrar las gráficas en el cuaderno](#mostrar-las-gráficas-en-el-cuaderno)
        - [Usar el sistemas de ficheros de Google Drive](#usar-el-sistemas-de-ficheros-de-google-drive)
    - [Uso de GPU](#uso-de-gpu)
        - [Modo interactivo](#modo-interactivo)
        - [Se selecciona la GPU](#se-selecciona-la-gpu)
    - [Utilidades varias](#utilidades-varias)
        - [Generación de números aleatorios](#generación-de-números-aleatorios)
        - [Ignora las advertencias](#ignora-las-advertencias)
        - [Extraer fichero](#extraer-fichero)
        - [Leer fichero CSV](#leer-fichero-csv)
    - [Preprocesado de datos](#preprocesado-de-datos)
        - [Recortamos la imagen usando la máscara de la lesión](#recortamos-la-imagen-usando-la-máscara-de-la-lesión)
        - [Recortamos aleatoriamente la imagen](#recortamos-aleatoriamente-la-imagen)
        - [Recortamos el área central de la imagen](#recortamos-el-área-central-de-la-imagen)
        - [Rescalamos la imagen a un tamaño determinado](#rescalamos-la-imagen-a-un-tamaño-determinado)
        - [Recortamos el área central de la imagen](#recortamos-el-área-central-de-la-imagen-1)
        - [Recortamos el área central de la imagen con un tamaño aleatorio](#recortamos-el-área-central-de-la-imagen-con-un-tamaño-aleatorio)
        - [Recortamos la imagen usando la máscara de la lesión](#recortamos-la-imagen-usando-la-máscara-de-la-lesión-1)
        - [Recortamos aleatoriamente la imagen](#recortamos-aleatoriamente-la-imagen-1)
        - [Re-escalamos la imagen a un tamaño determinado](#re-escalamos-la-imagen-a-un-tamaño-determinado)
        - [Rotación aleatoria](#rotación-aleatoria)
        - [Giro horizontal aleatorio](#giro-horizontal-aleatorio)
        - [Giro vertical aleatorio](#giro-vertical-aleatorio)
        - [Cambiar color de piel](#cambiar-color-de-piel)
        - [Cambiar color de piel de manera aleatoria](#cambiar-color-de-piel-de-manera-aleatoria)
        - [Normalizamos los datos restando la media y dividiendo por las desviaciones típicas](#normalizamos-los-datos-restando-la-media-y-dividiendo-por-las-desviaciones-típicas)
        - [Convertimos ndarrays de la muestra en tensores](#convertimos-ndarrays-de-la-muestra-en-tensores)
        - [Convertir las imágenes a un tensor](#convertir-las-imágenes-a-un-tensor)
        - [Normalizar las imágenes restando 05 y diviendo por 05 cada canal](#normalizar-las-imágenes-restando-05-y-diviendo-por-05-cada-canal)
        - [Transformación compuesta](#transformación-compuesta)
    - [Parámetros del entrenamiento](#parámetros-del-entrenamiento)
        - [Las clases de nuestra base de datos](#las-clases-de-nuestra-base-de-datos)
        - [Definimos el tamaño del *batch*, es decir, el tamaño del conjunto de muestras para calcular la dirección del gradiente, pues usaremos la estrategia *mini-batch SGD*](#definimos-el-tamaño-del-batch-es-decir-el-tamaño-del-conjunto-de-muestras-para-calcular-la-dirección-del-gradiente-pues-usaremos-la-estrategia-mini-batch-sgd)
    - [Cargar imágenes y conjuntos](#cargar-imágenes-y-conjuntos)
        - [Definimos las transformaciones que le vamos a aplicar a las imágenes de la base de datos](#definimos-las-transformaciones-que-le-vamos-a-aplicar-a-las-imágenes-de-la-base-de-datos)
        - [Definir los conjuntos de entrenamiento y testeo para una base de datos genérica](#definir-los-conjuntos-de-entrenamiento-y-testeo-para-una-base-de-datos-genérica)
        - [Uso de la clase *Dataset*](#uso-de-la-clase-dataset)
        - [Para cargar un conjunto de datos con la clase *Dataset*](#para-cargar-un-conjunto-de-datos-con-la-clase-dataset)
        - [Funciones de carga de las bases de datos](#funciones-de-carga-de-las-bases-de-datos)
    - [Funciones y acciones útiles](#funciones-y-acciones-útiles)
        - [Si usamos una base de datos local con estructura de fichero CSV, es de utilidad crear una variable que nos permite indexar las imágenes](#si-usamos-una-base-de-datos-local-con-estructura-de-fichero-csv-es-de-utilidad-crear-una-variable-que-nos-permite-indexar-las-imágenes)
        - [Definimos una función que nos permite visualizar una imagen a partir de un tensor torch normalizado](#definimos-una-función-que-nos-permite-visualizar-una-imagen-a-partir-de-un-tensor-torch-normalizado)
        - [Definimos una función que nos permite visualizar una imagen con un título](#definimos-una-función-que-nos-permite-visualizar-una-imagen-con-un-título)
        - [Mostrar un batch de imágenes de entrenamiento](#mostrar-un-batch-de-imágenes-de-entrenamiento)
        - [Mostrar un batch de imágenes de test](#mostrar-un-batch-de-imágenes-de-test)
        - [Mostrar una imagen local](#mostrar-una-imagen-local)
        - [Mostramos los datos de la imagen indicada en una base de datos local](#mostramos-los-datos-de-la-imagen-indicada-en-una-base-de-datos-local)
        - [Mostrar imágenes de un conjunto cargado a la clase *Dataset*](#mostrar-imágenes-de-un-conjunto-cargado-a-la-clase-dataset)
        - [Definimos una función auxiliar para visualizar un batch de datos](#definimos-una-función-auxiliar-para-visualizar-un-batch-de-datos)
        - [Mostramos varios batches del conjunto de datos de entrenamiento](#mostramos-varios-batches-del-conjunto-de-datos-de-entrenamiento)
    - [Definir CNN](#definir-cnn)
        - [Clase de la red (basada en LeNet)](#clase-de-la-red-basada-en-lenet)
        - [Clase de la red (basada en AlexNet)](#clase-de-la-red-basada-en-alexnet)
        - [Creamos la red neuronal que entrenaremos](#creamos-la-red-neuronal-que-entrenaremos)
        - [Cargamos un modelo de red ya existente](#cargamos-un-modelo-de-red-ya-existente)
        - [Hacemos *fine-tuning* en un problema](#hacemos-fine-tuning-en-un-problema)
        - [Parámetros de la red](#parámetros-de-la-red)
        - [Dimensiones de los datos de la red](#dimensiones-de-los-datos-de-la-red)
        - [Función para visualizar modelo de la red](#función-para-visualizar-modelo-de-la-red)
    - [Función de pérdida y optimizador](#función-de-pérdida-y-optimizador)
        - [Usando AUC](#usando-auc)
        - [Definimos la función de pérdida](#definimos-la-función-de-pérdida)
        - [Definimos el optimizador](#definimos-el-optimizador)
        - [*Scheduler*](#scheduler)
    - [Entrenamiento](#entrenamiento)
        - [Precalculamos el número de iteraciones](#precalculamos-el-número-de-iteraciones)
        - [Bucle de iteración](#bucle-de-iteración)
        - [*Buble* de iteración usando AUC](#buble-de-iteración-usando-auc)
        - [Guardamos el modelo](#guardamos-el-modelo)
    - [Evaluación](#evaluación)
        - [Preparamos la evaluación](#preparamos-la-evaluación)
        - [Salida](#salida)
        - [Comprobamos cómo de segura está la red de sus decisiones](#comprobamos-cómo-de-segura-está-la-red-de-sus-decisiones)
        - [Calcular la precisión (*accuracy*)](#calcular-la-precisión-accuracy)
        - [Contabilizar de forma independiente las diferentes clases](#contabilizar-de-forma-independiente-las-diferentes-clases)
        - [Matriz de confusión](#matriz-de-confusión)
        - [Función para generar la matriz de testeo de una red](#función-para-generar-la-matriz-de-testeo-de-una-red)
